...
<head>
    ...
    <title>Reporte de ocupación Biblioteca de Psicología y Filosofía</title>
...
<body>
    ...
    <div style="font-size: 4em;">Biblioteca de Psicología y Filosofía</div>
    <form method="POST" action="">
        <input type="hidden" name="biblioteca" value="PYF">
    ...
    $result = $db->query('SELECT ocupacion, timestamp FROM reportes WHERE biblioteca = "PYF"');
