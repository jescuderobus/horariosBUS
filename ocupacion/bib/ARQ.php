...
<head>
    ...
    <title>Reporte de ocupación Biblioteca de Arquitectura y Edificación</title>
...
<body>
    ...
    <div style="font-size: 4em;">Biblioteca de Arquitectura y Edificación</div>
    <form method="POST" action="">
        <input type="hidden" name="biblioteca" value="ARQ">
    ...
    $result = $db->query('SELECT ocupacion, timestamp FROM reportes WHERE biblioteca = "ARQ"');
