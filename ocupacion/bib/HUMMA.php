...
<head>
    ...
    <title>Reporte de ocupación Biblioteca de Humanidades (Sala Manuales)</title>
...
<body>
    ...
    <div style="font-size: 4em;">Biblioteca de Humanidades (Sala Manuales)</div>
    <form method="POST" action="">
        <input type="hidden" name="biblioteca" value="HUMMA">
    ...
    $result = $db->query('SELECT ocupacion, timestamp FROM reportes WHERE biblioteca = "HUMMA"');
