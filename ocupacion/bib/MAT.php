...
<head>
    ...
    <title>Reporte de ocupación Biblioteca de Matemáticas</title>
...
<body>
    ...
    <div style="font-size: 4em;">Biblioteca de Matemáticas</div>
    <form method="POST" action="">
        <input type="hidden" name="biblioteca" value="MAT">
    ...
    $result = $db->query('SELECT ocupacion, timestamp FROM reportes WHERE biblioteca = "MAT"');
