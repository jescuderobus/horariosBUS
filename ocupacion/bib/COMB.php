...
<head>
    ...
    <title>Reporte de ocupación Biblioteca de Comunicación</title>
...
<body>
    ...
    <div style="font-size: 4em;">Biblioteca de Comunicación</div>
    <form method="POST" action="">
        <input type="hidden" name="biblioteca" value="COMB">
    ...
    $result = $db->query('SELECT ocupacion, timestamp FROM reportes WHERE biblioteca = "COMB"');
