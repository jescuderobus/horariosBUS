...
<head>
    ...
    <title>Reporte de ocupación Biblioteca de Informática</title>
...
<body>
    ...
    <div style="font-size: 4em;">Biblioteca de Informática</div>
    <form method="POST" action="">
        <input type="hidden" name="biblioteca" value="INF">
    ...
    $result = $db->query('SELECT ocupacion, timestamp FROM reportes WHERE biblioteca = "INF"');
