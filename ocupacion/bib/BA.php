...
<head>
    ...
    <title>Reporte de ocupación Biblioteca de Bellas Artes</title>
...
<body>
    ...
    <div style="font-size: 4em;">Biblioteca de Bellas Artes</div>
    <form method="POST" action="">
        <input type="hidden" name="biblioteca" value="BA">
    ...
    $result = $db->query('SELECT ocupacion, timestamp FROM reportes WHERE biblioteca = "BA"');
