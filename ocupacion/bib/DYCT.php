...
<head>
    ...
    <title>Reporte de ocupación Biblioteca de Derecho y Ciencias del Trabajo</title>
...
<body>
    ...
    <div style="font-size: 4em;">Biblioteca de Derecho y Ciencias del Trabajo</div>
    <form method="POST" action="">
        <input type="hidden" name="biblioteca" value="DYCT">
    ...
    $result = $db->query('SELECT ocupacion, timestamp FROM reportes WHERE biblioteca = "DYCT"');
