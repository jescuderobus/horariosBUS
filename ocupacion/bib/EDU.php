...
<head>
    ...
    <title>Reporte de ocupación Biblioteca de Educación</title>
...
<body>
    ...
    <div style="font-size: 4em;">Biblioteca de Educación</div>
    <form method="POST" action="">
        <input type="hidden" name="biblioteca" value="EDU">
    ...
    $result = $db->query('SELECT ocupacion, timestamp FROM reportes WHERE biblioteca = "EDU"');
