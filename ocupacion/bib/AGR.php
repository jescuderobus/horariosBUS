...
<head>
    ...
    <title>Reporte de ocupación Biblioteca de Agronomía</title>
...
<body>
    ...
    <div style="font-size: 4em;">Biblioteca de Agronomía</div>
    <form method="POST" action="">
        <input type="hidden" name="biblioteca" value="AGR">
    ...
    $result = $db->query('SELECT ocupacion, timestamp FROM reportes WHERE biblioteca = "AGR"');
