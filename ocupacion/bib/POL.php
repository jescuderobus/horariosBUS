...
<head>
    ...
    <title>Reporte de ocupación Biblioteca de Ciencias Políticas</title>
...
<body>
    ...
    <div style="font-size: 4em;">Biblioteca de Ciencias Políticas</div>
    <form method="POST" action="">
        <input type="hidden" name="biblioteca" value="POL">
    ...
    $result = $db->query('SELECT ocupacion, timestamp FROM reportes WHERE biblioteca = "POL"');
