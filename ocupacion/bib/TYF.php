...
<head>
    ...
    <title>Reporte de ocupación Biblioteca de Turismo y Finanzas</title>
...
<body>
    ...
    <div style="font-size: 4em;">Biblioteca de Turismo y Finanzas</div>
    <form method="POST" action="">
        <input type="hidden" name="biblioteca" value="TYF">
    ...
    $result = $db->query('SELECT ocupacion, timestamp FROM reportes WHERE biblioteca = "TYF"');
