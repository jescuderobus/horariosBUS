...
<head>
    ...
    <title>Reporte de ocupación Biblioteca de Economía</title>
...
<body>
    ...
    <div style="font-size: 4em;">Biblioteca de Economía</div>
    <form method="POST" action="">
        <input type="hidden" name="biblioteca" value="ECO">
    ...
    $result = $db->query('SELECT ocupacion, timestamp FROM reportes WHERE biblioteca = "ECO"');
