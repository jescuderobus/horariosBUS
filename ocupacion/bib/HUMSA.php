...
<head>
    ...
    <title>Reporte de ocupación Biblioteca de Humanidades (Sala de Arte)</title>
...
<body>
    ...
    <div style="font-size: 4em;">Biblioteca de Humanidades (Sala de Arte)</div>
    <form method="POST" action="">
        <input type="hidden" name="biblioteca" value="HUMSA">
    ...
    $result = $db->query('SELECT ocupacion, timestamp FROM reportes WHERE biblioteca = "HUMSA"');
